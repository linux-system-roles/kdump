...
- ci: Bump actions/checkout from 6 to 7 (#295)
- ci: Use our own pr_title_lint.py instead of NPM commitlint [citest_skip] (#296)
- ci: bump tox-lsr version to 3.20.0 to fix tox 4.58 api breakage [citest_skip] (#297)
- ci: Add support for Fedora 44 and drop Fedora 42 - use ansible-core 2.21 [citest_skip] (#299)
- ci: Bump actions/setup-python from 6 to 7 (#300)
- ci: ensure dependabot updates do not invoke ci tests [citest_skip] (#301)
...
- ci: Bump actions/github-script from 8 to 9 (#289)
- refactor: use ansible.posix 2.1.X for EL7 compatibility [citest_skip] (#290)
- ci: Add config file for CodeRabbit with custom rules (#291)
- ci: Skip reviews for PRs with [citest_skip] in the title (#292)
- test: remove unused files [citest_skip] (#293)
...
- ci: use ANSIBLE_INJECT_FACT_VARS=false by default for testing (#272)
- ci: Bump ansible/ansible-lint from 25 to 26 (#273)
- ci: skip most CI checks if title contains citest skip [citest_skip] (#274)
- ci: ansible-lint - remove .collection directory from converted collection [citest_skip] (#275)
- ci: tox-lsr version 3.15.0 [citest_skip] (#276)
- ci: Add Fedora 43, remove Fedora 41 from Testing Farm CI (#277)
- ci: Bump actions/upload-artifact from 6 to 7 (#279)
- ci: tox-lsr 3.17.1 - previous update broke container tests, this fixes them [citest_skip] (#281)
- ci: fix yum repos to use devel site instead of old site name [citest_skip] (#283)
- ci: update header for run_role_with_clear_facts [citest_skip] (#284)
